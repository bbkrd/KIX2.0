 ...
 */
public class AnnualOverlapMethodsTest {
    ...
    public AnnualOverlapMethodsTest() {
    }
    ...
    public void testMid() {
        ...
        TsData result = AnnualOverlapMethods.mid(a, false);
    ...
    public void testChainSum_TsData() {
        ...
        TsData result = AnnualOverlapMethods.chainSum(weightedSum);
    ...
    public void testUnchain_TsData() {
        ...
        TsData result = AnnualOverlapMethods.unchain(a);
        assertArrayEquals(expResultData, result.internalStorage(), 0.005);
    }

    @Test
    public void testAnnualOverlapMethodsWellDefined() throws ReflectiveOperationException {
        UtilityClassTestUtil.assertUtilityClassWellDefined(AnnualOverlapMethods.class);
    }
}
